 <?php if (have_posts()) : ?>
    ...
    <article class="uk-article tm-blog-single" data-permalink="<?php the_permalink(); ?>">

        <div class="uk-block uk-text-center single-img">
            <?php if (has_post_thumbnail()) : ?>
                <?php the_post_thumbnail(); ?>
            <?php endif; ?>
        </div>
        <div class="uk-block uk-text-center uk-margin-top uk-padding-remove what-we-do">
            <h1 class="uk-article-title uk-h1 tm-heading-line"><?php the_title(); ?></h1>
        </div>
