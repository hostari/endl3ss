...
if ($config("$site.toolbar_transparent")) {
    ...
    if ($config("$header.transparent")) {
        $attrs_toolbar['class'][] = "uk-{$config("$header.transparent")}";
    } elseif ($outside && $config("$site.boxed.header_transparent")) {
        $attrs_toolbar['class'][] = "uk-{$config("$site.boxed.header_transparent")}";
    } else {
        $attrs_toolbar['class'][] = 'js-toolbar-transparent tm-toolbar-default';
    }
